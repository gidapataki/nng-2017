...
class Hungarian {
  ...
  public:
    ...
    int init(const vector<vector<int>> &input_matrix, int rows, int cols,
             MODE mode);
  ...
  protected:
    bool check_solution(const vector<int> &row_dec, const vector<int> &col_inc,
                        const vector<int> &col_vertex);
    bool assign_solution(const vector<int> &row_dec, const vector<int> &col_inc,
                         const vector<int> &col_vertex);
